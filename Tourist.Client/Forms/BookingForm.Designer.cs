namespace Tourist.Server.Forms
{
	partial class BookingsForm
	{
		...
		private void InitializeComponent( )
		{
			...
			// RoomsTab
			// 
			this.RoomsTab.Controls.Add(this.BookingsDataGrid);
			...
			this.BookingsDataGrid.CellValidating += new System.Windows.Forms.DataGridViewCellValidatingEventHandler(this.BookingsDataGrid_RowsValidating);
			this.BookingsDataGrid.RowsRemoved += new System.Windows.Forms.DataGridViewRowsRemovedEventHandler(this.BookingsDataGrid_RowsRemoved);
			// 
			// ActivitiesTab
			// 
		...
		private System.Windows.Forms.DataGridViewComboBoxColumn ClientNifColumn;
		...
		private System.Windows.Forms.DataGridViewComboBoxColumn ServiceColumn;

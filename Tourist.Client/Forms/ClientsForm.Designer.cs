namespace Tourist.Server.Forms
{
	partial class ClientsForm
	{
		...
		private void InitializeComponent( )
		{
			...
			this.ClientsDataGrid.CellValidating += new System.Windows.Forms.DataGridViewCellValidatingEventHandler(this.ClientsDataGrid_RowsValidating);
			this.ClientsDataGrid.RowsRemoved += new System.Windows.Forms.DataGridViewRowsRemovedEventHandler(this.ClientsDataGrid_RowsRemoved);
			// 
			// IdColumn
			// 

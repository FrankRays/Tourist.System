namespace Tourist.Client.Forms
{
	partial class OldBookingsForm
	{
		...
		private void InitializeComponent( )
		{
			...
			this.RoomBookingsDataGrid.CellClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.RoomBookingsDataGrid_CellClick);
			this.RoomBookingsDataGrid.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.RoomBookingsDataGrid_CellDoubleClick);
			this.RoomBookingsDataGrid.CellValidating += new System.Windows.Forms.DataGridViewCellValidatingEventHandler(this.RoomBookingsDataGrid_CellValidating);
			this.RoomBookingsDataGrid.RowsRemoved += new System.Windows.Forms.DataGridViewRowsRemovedEventHandler(this.RoomBookingsDataGrid_RowRemoved);
			// 
			// R_IdColumn
			// 

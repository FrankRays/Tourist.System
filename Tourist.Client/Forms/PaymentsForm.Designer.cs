namespace Tourist.Client.Forms
{
	partial class PaymentsForm
	{
		...
		private void InitializeComponent( )
		{
			...
			this.RoomPaymentType = new System.Windows.Forms.DataGridViewComboBoxColumn();
			this.RoomPaymentHeader = new System.Windows.Forms.DataGridViewButtonColumn();
			...
			this.ActivityTypeHeader = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.ActivityPaymentTypeHeader = new System.Windows.Forms.DataGridViewComboBoxColumn();
			this.ActivityPaymentHeader = new System.Windows.Forms.DataGridViewButtonColumn();
			...
			this.TransportTypeHeader = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.TransportPaymentTypeHeader = new System.Windows.Forms.DataGridViewComboBoxColumn();
			this.TransportPaymentHeader = new System.Windows.Forms.DataGridViewButtonColumn();
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.ImagePanel.BackgroundImage = global::Tourist.Client.Properties.Resources.Payment;
			this.ImagePanel.BackgroundImageLayout = System.Windows.Forms.ImageLayout.None;
			this.ImagePanel.Location = new System.Drawing.Point(1086, 32);
			this.ImagePanel.Margin = new System.Windows.Forms.Padding(2);
			this.ImagePanel.Name = "ImagePanel";
			this.ImagePanel.Size = new System.Drawing.Size(98, 94);
			...
			this.SubTitleLabel.Text = "Payment Services";
			// 
			// TitleLabel
			// 
			...
			this.TitleLabel.Location = new System.Drawing.Point(98, 31);
			this.TitleLabel.Margin = new System.Windows.Forms.Padding(2, 0, 2, 0);
			this.TitleLabel.Name = "TitleLabel";
			this.TitleLabel.Size = new System.Drawing.Size(188, 51);
			this.TitleLabel.TabIndex = 3;
			this.TitleLabel.Text = "Payments";
			// 
			// BodyPanel
			// 
			...
			this.ClientsTabsControl.Location = new System.Drawing.Point(232, 12);
			...
			this.ClientsTabsControl.Size = new System.Drawing.Size(952, 443);
			...
			// RoomsTab
			// 
			this.RoomsTab.Controls.Add(this.ClientsGrid);
            ...
            this.RoomPaymentType,
            this.RoomPaymentHeader});
			...
			this.ClientsGrid.Location = new System.Drawing.Point(-1, 34);
			...
			this.ClientsGrid.Size = new System.Drawing.Size(946, 406);
			this.ClientsGrid.TabIndex = 20;
			// 
			// RoomClientIDHeader
			// 
			...
			// RoomIDHeader
			// 
			this.RoomIDHeader.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.AllCells;
			this.RoomIDHeader.HeaderText = "Room ID";
			this.RoomIDHeader.Name = "RoomIDHeader";
			this.RoomIDHeader.Width = 110;
			// 
			// RoomTypeHeader
			// 
			...
			// CheckInDateHeader
			// 
			this.CheckInDateHeader.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.AllCells;
			this.CheckInDateHeader.HeaderText = "Check In Date";
			this.CheckInDateHeader.Name = "CheckInDateHeader";
			this.CheckInDateHeader.Width = 153;
			// 
			// CheckOutDateHeader
			// 
			this.CheckOutDateHeader.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.AllCells;
			this.CheckOutDateHeader.HeaderText = "Check Out Date";
			...
			// StayNightsHeader
			// 
			this.StayNightsHeader.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.AllCells;
			this.StayNightsHeader.HeaderText = "Stay Nights";
			...
			// RoomPaymentType
			// 
			this.RoomPaymentType.HeaderText = "Payament Type";
			this.RoomPaymentType.Name = "RoomPaymentType";
			this.RoomPaymentType.Width = 144;
			// 
			// RoomPaymentHeader
			// 
			this.RoomPaymentHeader.HeaderText = "Payment";
			this.RoomPaymentHeader.Name = "RoomPaymentHeader";
			this.RoomPaymentHeader.Resizable = System.Windows.Forms.DataGridViewTriState.True;
			this.RoomPaymentHeader.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.Automatic;
			this.RoomPaymentHeader.Width = 109;
			// 
			// ActivitiesTab
			// 
            ...
            this.ActivityPaymentTypeHeader,
            this.ActivityPaymentHeader});
			...
			// 
			// ActivityPaymentTypeHeader
			// 
			this.ActivityPaymentTypeHeader.HeaderText = "Payement Type";
			this.ActivityPaymentTypeHeader.Name = "ActivityPaymentTypeHeader";
			this.ActivityPaymentTypeHeader.Resizable = System.Windows.Forms.DataGridViewTriState.True;
			this.ActivityPaymentTypeHeader.Width = 144;
			// 
			// ActivityPaymentHeader
			// 
			this.ActivityPaymentHeader.HeaderText = "Payment ";
			this.ActivityPaymentHeader.Name = "ActivityPaymentHeader";
			this.ActivityPaymentHeader.Width = 95;
			// 
			// TransportsTab
			// 
			...
			this.TransportsTab.Size = new System.Drawing.Size(944, 385);
            ...
            this.TransportPaymentTypeHeader,
            this.TransportPaymentHeader});
			...
			this.metroGrid2.Size = new System.Drawing.Size(949, 349);
			...
			// 
			// TransportPaymentTypeHeader
			// 
			this.TransportPaymentTypeHeader.HeaderText = "Payement Type";
			this.TransportPaymentTypeHeader.Name = "TransportPaymentTypeHeader";
			this.TransportPaymentTypeHeader.Width = 144;
			// 
			// TransportPaymentHeader
			// 
			this.TransportPaymentHeader.HeaderText = "Payment";
			this.TransportPaymentHeader.Name = "TransportPaymentHeader";
			this.TransportPaymentHeader.Width = 90;
			// 
			// GroupSearch
			// 
			...
			this.GroupSearch.Size = new System.Drawing.Size(198, 157);
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn ActivityTypeHeader;
		...
		private System.Windows.Forms.DataGridViewComboBoxColumn ActivityPaymentTypeHeader;
		private System.Windows.Forms.DataGridViewButtonColumn ActivityPaymentHeader;
		...
		private System.Windows.Forms.DataGridViewComboBoxColumn RoomPaymentType;
		private System.Windows.Forms.DataGridViewButtonColumn RoomPaymentHeader;
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn TransportTypeHeader;
		...
		private System.Windows.Forms.DataGridViewComboBoxColumn TransportPaymentTypeHeader;
		private System.Windows.Forms.DataGridViewButtonColumn TransportPaymentHeader;
